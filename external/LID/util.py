...
STDEVS = {
    'mnist': {'fgsm': 0.271, 'df': 0.511, 'cw': 0.407, 'lbfgs': 0.601, 'enm': 0.621, 'jsma': 0.328, 'vam': 0.352,
              'bim': 0.528, 'mim': 0.628, 'spsa': 0.587},
    'fmnist': {'fgsm': 0.571, 'df': 0.511, 'cw': 0.407, 'lbfgs': 0.601, 'enm': 0.621, 'jsma': 0.328, 'vam': 0.352,
               'bim': 0.528, 'mim': 0.628, 'spsa': 0.587},
    'cifar10': {'fgsm': 0.0504, 'bim-a': 0.0084, 'bim-b': 0.0428, 'cw-l2': 0.007, 'cw': 0.007},
    'svhn': {'fgsm': 0.133, 'bim': 0.0155, 'cw-l2': 0.008, 'cw': 0.008}
}
...
def get_noisy_samples(X_test, X_test_adv, dataset, attack):
    ...
    if attack in ['jsma', 'cw']:
        ...
        X_test_noisy = np.minimum(
            np.maximum(
                X_test + np.random.normal(loc=0, scale=FLAGS.stdevs,
                                          # scale=STDEVS[dataset][attack],
                                          size=X_test.shape),
                CLIP_MIN
            ),
            CLIP_MAX
